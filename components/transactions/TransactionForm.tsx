...
import { IconArrowLeft, IconCalendar, IconLoader, IconPlus, IconTrash, IconUsers, IconChevronLeft, IconX, IconSparkles, IconCopy, IconCheck } from "@tabler/icons-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
