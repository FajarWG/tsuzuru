  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-[400px] rounded-3xl p-6">
        ...
        <div className="grid grid-cols-1 gap-3.5 border-y border-border/10 py-4 my-2">
          {/* Step 1 */}
        ...
        <div className="bg-muted/40 border border-border/20 rounded-xl p-3 text-center mb-1">
